...
contract EterlandPresale is Presale {
    ...
    Presale(presaleStart,presaleEnd,ceo,coo,cfo,inv1,inv2) {
        ...
        Kits[COMMON_KIT] = Kit(100000000000000000, 30);
        Kits[UNCOMMON_KIT] = Kit(165000000000000000, 30);
        Kits[RARE_KIT] = Kit(250000000000000000, 30);
        Kits[UNKNOWN_DEPOSIT] = Kit(2180000000000000000, 30);
        Kits[LOST_MAP] = Kit(100000000000000000, 30);
        Kits[GOLDEN_MAP_CHEST] = Kit(100000000000000000, 30);
        Kits[GOLDEN_DEPOSIT_CHEST] = Kit(100000000000000000, 30);
        Kits[WOOD_MAP_CHEST] = Kit(100000000000000000, 30);
        Kits[DEPOSIT_WOOD_CHEST] = Kit(100000000000000000, 30);
    }
